...
class TestChunkSplitter(unittest.TestCase):
    def test_paragraph_split_zh(self):
        ...
        self.assertTrue(
            any("这是第一段" in chunk for chunk in chunks)
            or any("这是第二段" in chunk for chunk in chunks)
        )
    ...
    def test_paragraph_split_en(self):
        ...
        # Just verify we get some chunks
        self.assertTrue(
            any("first paragraph" in chunk for chunk in chunks)
            or any("second paragraph" in chunk for chunk in chunks)
        )
    ...
    def test_multiple_documents(self):
        ...
        documents = [
            "This is document one. It has one paragraph.",
        ...
        self.assertTrue(
            any("document one" in chunk for chunk in chunks)
            or any("document two" in chunk for chunk in chunks)
        )
