...
class CheckSchema:
    ...
    def _validate_vertex_label(self, vertex_label: Dict[str, Any]) -> None:
        ...
        check_type(
            vertex_label["properties"], list, "'properties' in vertex_label is not of correct type."
        )
    ...
    def _validate_edge_label(self, edge_label: Dict[str, Any]) -> None:
        ...
        check_type(
            edge_label["source_label"], str, "'source_label' in edge_label is not of correct type."
        )
        check_type(
            edge_label["target_label"], str, "'target_label' in edge_label is not of correct type."
        )
